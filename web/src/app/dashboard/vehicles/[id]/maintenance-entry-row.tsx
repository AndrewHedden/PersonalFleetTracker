...
/**
 * One row in the "Recent maintenance" list. The collapsed row is clickable —
 * clicking it opens the entry into the maintenance form (edit mode) plus a
 * delete action (with a lightweight inline confirm). `onChanged` re-fetches the
 * list after an edit or delete.
 */
  ...
  return (
    <li>
      <button
        ...
        className="-mx-2 flex w-full flex-col gap-1 rounded px-2 py-2 text-left hover:bg-zinc-100 dark:hover:bg-zinc-900"
      >
